...
export default function LoginPage() {
      ...
      if (typeof window !== "undefined") {
        ...
        if (win.google) {
          ...
          win.google.accounts.id.renderButton(
            ...
            { theme: "outline", size: "large", width: 356, shape: "pill", text: "signin_with" }
          );
        }
      }
    };
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    if (checkRes.success) {
      ...
      setError(checkRes.error || t("login_page.error_invalid_credentials"));
    }
  };
      ...
      <Card className="w-full max-w-[420px] bg-[#0C0C0E] border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.4)] p-8 z-10 rounded-[28px]">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-[13px] text-[#A0A0A5]">
            {isVerifyingEmail ? t("login_page.otp_title") : t("forms.login")}
          </p>
        </div>
