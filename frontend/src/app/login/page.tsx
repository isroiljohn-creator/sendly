...
export default function LoginPage() {
  ...
  const handleEmailSubmit = (e: React.FormEvent) => {
    ...
    if (checkRes.success) {
      ...
      setError(checkRes.error || "Pochta yoki parol noto'g'ri.");
    }
  };
      ...
      <Card className="w-full max-w-[420px] bg-[#0C0C0E] border border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.4)] p-8 z-10 rounded-[28px]">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-[13px] text-[#A0A0A5]">
            {isVerifyingEmail ? "Pochtani tasdiqlash" : t("forms.login")}
          </p>
        </div>
        ...
        {!isVerifyingEmail && (
          <>
            <form onSubmit={handleEmailSubmit} className="mt-6 flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="mt-3 w-full rounded-full bg-white text-black font-bold py-3.5 text-[13.5px] transition-all active:scale-[0.98] hover:bg-white/95"
              >
                {t("forms.login")}
              </button>
            </form>
            ...
            <div className="mt-7 text-center text-[12px] text-[#A0A0A5]">
              {t("forms.no_account")}{" "}
              <Link href="/register" className="font-semibold text-white hover:text-[#C7F33C] hover:underline">
                {t("forms.register")}
              </Link>
            </div>
          </>
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/60 backdrop-blur-[6px] p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-[420px] rounded-[28px] bg-white p-7 text-black shadow-[0_25px_60px_rgba(0,0,0,0.3)] border border-[#E8E8E8] animate-in zoom-in-95 duration-200 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="mt-3 text-[17px] font-bold text-black">{"Google orqali kirish"}</h3>
            ...
            <div className="mt-8 text-[11px] text-[#707075] text-left leading-relaxed">
              {"Sendly keyingi kirishlarni osonlashtirish uchun sizning ismingiz, pochtangiz va profil rasmingizni oladi. Maxfiylik kelishuviga rioya etiladi."}
            </div>
